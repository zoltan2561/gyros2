                        ...
                        <div id="category" class="owl-carousel mt-2">
                            <?php $__currentLoopData = helper::get_categories(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorydata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="category-wrapper category-item rounded-4 reveal"
                                     style="transition-delay: <?php echo e(($loop->index % 6) * 80); ?>ms">
                                    ...
                                    <div class="text-center pt-3 category-text">
                                        ...
                                        <p class="fs-7 fw-400 text-primary mb-0">
                                            <?php echo e($categorydata->item_info->count()); ?> <?php echo e(trans('labels.item')); ?>
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gyros2\resources\views/web/home1/index.blade.php ENDPATH**/ ?>