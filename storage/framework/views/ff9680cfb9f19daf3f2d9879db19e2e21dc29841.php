...
<ul class="navbar-nav">
    ...
    <li class="nav-item mb-2 fs-7 <?php echo e(Auth::user()->type != 1 ? (in_array('23', $modules) == true ? '' : 'd-none') : ''); ?>"
        ...
        <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/systemaddons*') ? 'active' : ''); ?>"
            ...
            <i class="fa fa-puzzle-piece"></i><span class="nav-text d-flex justify-content-between w-100"><?php echo e(trans('labels.addons_manager')); ?></span>
    ...
    <?php if(@helper::checkaddons('store_review')): ?>
        <li class="nav-item mb-2 fs-7 <?php echo e(Auth::user()->type != 1 ? (in_array('14', $modules) == true ? '' : 'd-none') : ''); ?>"
            ...
            <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/store-review*') ? 'active' : ''); ?>"
                ...
                <i class="fa-solid fa-star"></i><span class="nav-text "><?php echo e(trans('labels.store_reviews')); ?></span>
            </a>
        </li>
    <?php endif; ?>
    <li class="nav-item mb-2 fs-7 <?php echo e(Auth::user()->type != 1 ? (in_array('15', $modules) == true ? '' : 'd-none') : ''); ?>"
        id="15">
        <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/bookings*') ? 'active' : ''); ?>"
            href="<?php echo e(URL::to('/admin/bookings')); ?>" aria-expanded="false">
            <i class="fa-solid fa-calendar-days"></i><span class="nav-text "><?php echo e(trans('labels.bookings')); ?></span>
        </a>
    </li>
    <li class="nav-item mb-2 fs-7 <?php echo e(Auth::user()->type != 1 ? (in_array('16', $modules) == true ? '' : 'd-none') : ''); ?>"
        id="16">
        <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/contact*') ? 'active' : ''); ?>"
            href="<?php echo e(URL::to('/admin/contact')); ?>" aria-expanded="false">
    ...
    <li class="nav-item mb-2 fs-7 <?php echo e(Auth::user()->type != 1 ? (in_array('18', $modules) == true ? '' : 'd-none') : ''); ?>"
        id="18">
        <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/driver*') ? 'active' : ''); ?>"
            href="<?php echo e(URL::to('/admin/driver')); ?>" aria-expanded="false">
    ...
    <?php endif; ?>
    <li class="nav-item mb-2 fs-7"
        <?php echo e(Auth::user()->type != 1 ? (in_array('27', $modules) == true ? '' : 'd-none') : ''); ?>" id="27">
        <a class="nav-link rounded d-flex <?php echo e(request()->is('admin/language-settings*') ? 'active' : ''); ?>"
            href="<?php echo e(URL::to('/admin/language-settings')); ?>" aria-expanded="false">
...
<?php /**PATH C:\xampp\htdocs\gyros2\resources\views/admin/theme/sidebarcontent.blade.php ENDPATH**/ ?>