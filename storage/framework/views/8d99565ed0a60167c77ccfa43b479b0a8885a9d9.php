                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card px-0 overflow-hidden border-bottom-0 rounded-3">
                                <div class="table-responsive">
                                    <table class="table m-0">
                                        ...
                                        <tr>
                                            <th class="cart-table-title p-3 text-white"><?php echo e(trans('labels.item')); ?></th>
                                            <th class="cart-table-title p-3 text-white"><?php echo e(trans('labels.price')); ?></th>
                                            <th class="cart-table-title p-3 text-white"><?php echo e(trans('labels.qty')); ?></th>
                                            <th class="cart-table-title p-3 text-white"><?php echo e(trans('labels.total')); ?></th>
                                            <th class="cart-table-title p-3 text-white text-center"><?php echo e(trans('labels.action')); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                        ...
                                        <?php $__currentLoopData = $getcartlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cartitems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr id="row-<?php echo e($cartitems->id); ?>" data-cart-row>
                                                <td>
                                                    <div class="tbl_cart_product gap-3">
                                                        <div class="col-auto d-none d-md-flex  justify-content-center item-img-none">
                                                            <div class="item-img">
                                                                <img src="<?php echo e(helper::image_path($cartitems->item_image)); ?>" alt="item-image">
                                                            </div>
                                                        </div>
                                                        <div class="tbl_cart_product_caption">
                                                            <h5 class="tbl_pr_title line-2 mb-1 fs-6">
                                                                <img
                                                                    <?php if($cartitems->item_type == 1): ?>
                                                                        src="<?php echo e(helper::image_path('veg.svg')); ?>"
                                                                    <?php else: ?>
                                                                        src="<?php echo e(helper::image_path('nonveg.svg')); ?>"
                                                                    <?php endif; ?>
                                                            ...
                                                            <?php if($cartitems->addons_id != '' || $cartitems->extras_id != ''): ?>
                                                                <small>
                                                                    <a class="text-muted fw-400 fs-7" href="javascript:void(0)"
                                                                       onclick="showaddons('<?php echo e($cartitems['addons_name']); ?>','<?php echo e($cartitems['addons_price']); ?>','<?php echo e($cartitems['extras_name']); ?>','<?php echo e($cartitems['extras_price']); ?>','<?php echo e($cartitems['item_name']); ?>')">
                                                ...
                                                <td>
                                                    <nav aria-label="Page navigation example">
                                                        <ul class="qtladd mb-0 <?php echo e(session()->get('direction') == '2' ? 'rtl' : ''); ?>">
                                                            <li>
                                                ...
                                                <td>
                                                    <h4 class="tbl_org_price"><?php echo e(helper::currency_format($total_price)); ?></h4>
                                                </td>
                                                <td>
                                                    <div class="tbl_pr_action">
                                                        ...
                                                        <button type="button"
                                                                ...
                                                                data-id="<?php echo e($cartitems['id']); ?>"
                                                                data-row="#row-<?php echo e($cartitems['id']); ?>"
                                                                data-url="<?php echo e(url('/cart/deleteitem')); ?>">
                            ...
                            <div class="row g-3 justify-content-between mt-0 align-items-center">
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 <?php echo e(session()->get('direction') == '2' ? 'text-end' : ''); ?>">
                                    <a href="<?php echo e(URL::to('/')); ?>" class="btn btn-outline-dark w-100">
                                        <i class="fa-solid <?php echo e(session()->get('direction') == '2' ? 'fa-circle-arrow-right ms-2' : 'fa-circle-arrow-left me-2'); ?>"></i>
                                        <?php echo e(trans('labels.continue_shopping')); ?>

                                    </a>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 <?php echo e(session()->get('direction') == '2' ? 'text-start' : 'text-end'); ?>">
    ...
    <script>
        (function () {
            ...
            document.addEventListener('click', function (e) {
                ...
                var url   = btn.getAttribute('data-url') || '<?php echo e(url('/cart/deleteitem')); ?>';
                var token = getCsrf();
...
<?php echo $__env->make('web.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gyros2\resources\views/web/cart/cart.blade.php ENDPATH**/ ?>