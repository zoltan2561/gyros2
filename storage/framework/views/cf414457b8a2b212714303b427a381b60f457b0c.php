                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="<?php echo e(URL::to('admin/tax/update-' . $taxdata->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name"
                                                placeholder="<?php echo e(trans('labels.name')); ?>" value="<?php echo e($taxdata->name); ?>"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="type" class="form-select" required>
                                                ...
                                                <option value="1" <?php echo e($taxdata->type == 1 ? 'selected' : ''); ?>>
                                                    <?php echo e(trans('labels.fixed')); ?>

                                                    (<?php echo e(helper::appdata()->currency); ?>)</option>
                                                <option value="2" <?php echo e($taxdata->type == 2 ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="col-form-label" for="tax"><?php echo e(trans('labels.tax')); ?> <span
                                                    class="text-danger">*</span> </label>
                                            <input type="text" class="form-control numbers_only" name="tax"
                                                id="tax" placeholder="<?php echo e(trans('labels.tax')); ?>"
                                                value="<?php echo e($taxdata->tax); ?>" required>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gyros2\resources\views/admin/tax/edit.blade.php ENDPATH**/ ?>