                            ...
                            <form action="<?php echo e(route('adduser')); ?>" method="POST">
                                ...
                                <div class="form-body mt-4">
                                    ...
                                    <?php if(!session()->has('social_login')): ?>
                                        ...
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <?php echo $__env->make('web.recaptcha.recaptcha', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <div class="form-group">
...
<?php /**PATH C:\xampp\htdocs\foody\resources\views/web/auth/register.blade.php ENDPATH**/ ?>