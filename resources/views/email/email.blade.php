                        ...
                        <div
                            ...
                            <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                                <div bgcolor="#f8f4e8" align="left"
                                    ...
                                    class="m_-7788511936867687679padding-copy">{{ trans('labels.dear') }}
                                    {{ $name }},
                                </div>
                                <div
                                    ...
                                    <div bgcolor="#f8f4e8" align="left"
                                        ...
                                        {{ trans('labels.somebody_requested_password') }} {{ $email }} <br>
                                        {{ trans('labels.your_new_password') }} <b style="color: #fe724c;">
                                            {{ $password }}</b><br> {{ trans('labels.kindly_update_password') }}
                                    </div>
                                    <div
