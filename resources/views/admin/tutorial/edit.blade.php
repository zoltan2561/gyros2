                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{ URL::to('admin/tutorial/update-' . $tutorialdata->id) }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"
                                                value="{{ $tutorialdata->title }}" placeholder="{{ trans('labels.title') }}"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <img src="{{ helper::image_path($tutorialdata->image) }}" alt=""
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" rows="5" placeholder="{{ trans('labels.description') }}"
                                                required>{{ $tutorialdata->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
